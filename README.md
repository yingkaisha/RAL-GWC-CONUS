...
* Create YAML and PBS files based on the following examples: [[Link]](https://github.com/yingkaisha/RAL-GWC-CONUS/tree/main/config).

## Navigation
* Model weights [[huggingface](https://huggingface.co/yingkaisha/CONUS404-AI-LAM/tree/main)]
