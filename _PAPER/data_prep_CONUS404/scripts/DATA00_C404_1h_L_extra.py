...
for i in range(L):
    ...
    ds_mlevel = ds_mlevel.rename({'SMOIS': 'WRF_SMOIS', 'TSLB': 'WRF_TSLB'})
    ds_mlevel = ds_mlevel.isel(soil_layers_stag=0)
    ...
    save_name = '/glade/campaign/ral/hap/ksha/DWC_data/CONUS_domain_GP/raw_404_L_extra/' + 'C404_GP_' + fn_2d[-22:-9] + 'H_L_extra.zarr'
    print(save_name)
