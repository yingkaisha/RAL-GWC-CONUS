...
#                'PREC_ACC_NC', 'PWAT', 'REFL_COM', 'MLCAPE', 'OLR']

var_3d_pick= ['U', 'V', 'P', 'QVAPOR', 'QCLOUD', 'QGRAUP', 'QICE', 'QRAIN', 'QSNOW']
...
for i in range(L):
    ...
    # integrate_Q_LC
    ds_mlevel['WRF_PWAT_LC'] = vertical_integral(ds_mlevel['WRF_Q_LC'], ds_mlevel['P'])
    
    # IVT components
    ds_mlevel['WRF_IVT_U'] = vertical_integral(ds_mlevel['WRF_Q_tot'] * ds_mlevel['U'], ds_mlevel['P'])
    ds_mlevel['WRF_IVT_V'] = vertical_integral(ds_mlevel['WRF_Q_tot'] * ds_mlevel['V'], ds_mlevel['P'])
    
    # -------------------------------------------------------- #
    ds_mlevel = ds_mlevel.drop_vars(['P', 'U', 'V', 'QVAPOR', 'QCLOUD', 'QGRAUP', 'QICE', 'QRAIN', 'QSNOW'])
    ...
    save_name = '/glade/campaign/ral/hap/ksha/DWC_data/CONUS_domain_GP/raw_404_Q_extra/' + 'C404_GP_' + fn_2d[-22:-9] + 'H_Q_extra.zarr'
    print(save_name)
