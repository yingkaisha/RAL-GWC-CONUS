...
source_dir = f'/glade/derecho/scratch/ksha/DWC/RAW_OUTPUT/CONUS_GP_CESM_HIST/'
fn_all = vu.get_nc_files(source_dir)[5] # 2005-2010
...
save_name = f'/glade/derecho/scratch/ksha/DWC_data/CONUS_domain_GP/opt_init_ERA5/prog_outputs/CESM_HIST/CESM_HIST_{ind_start:04d}_{ind_end:04d}_2070-01-01T00Z.zarr'
